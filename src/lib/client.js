...
var grpc_api_client_1 = require("@xmtp/grpc-api-client");
// Accept a config object as a parameter
function createClient(config) {
    if (config === void 0) { config = {}; }
    return __awaiter(this, void 0, void 0, function () {
        var key, wallet, defaultConfig, finalConfig, client;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    wallet = new ethers_1.Wallet(key);
                    ...
                    defaultConfig = {
                        ...
                        apiClientFactory: grpc_api_client_1.GrpcApiClient.fromOptions,
                    };
                    finalConfig = __assign(__assign({}, defaultConfig), config);
                    return [4 /*yield*/, xmtp_js_1.Client.create(wallet, finalConfig)];
                case 1:
                    client = _a.sent();
